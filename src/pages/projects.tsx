        ...
        <div className='mt-8 grid grid-cols-1 gap-4 md:grid-cols-2'>
          <Card shadow='normal'>
            <div className='flex flex-col'>
              ...
              <p className='mt-4'>
                The website is built from scratch, using React, to be a one-stop-shop for
                information about the OpenSource Club. It provides information about what the club
                is for, the projects we work on, and upcoming events. We hope to constantly update
          ...
          <Card shadow='normal'>
            <div className='flex flex-col'>
              ...
              <p className='mt-4'>
                ...
                it easier for students to plan out their schedules, and eventually to also do some
                of that for them
              </p>
